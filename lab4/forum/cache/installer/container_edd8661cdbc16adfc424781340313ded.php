...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000002c59043f000000007ac0391f(
...
class phpbbtemplatetwiglexer_000000002c59043f000000007ac0391f extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5dcedea584659052366045 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5dcedea58465d384400989 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5dcedea58464c099629374 = array(
    ...
    {
        $this->initializer5dcedea58465d384400989 && ($this->initializer5dcedea58465d384400989->__invoke($valueHolder5dcedea584659052366045, $this, 'set_environment', array('env' => $env), $this->initializer5dcedea58465d384400989) || 1) && $this->valueHolder5dcedea584659052366045 = $valueHolder5dcedea584659052366045;

        return $this->valueHolder5dcedea584659052366045->set_environment($env);
    }
    ...
    {
        $this->initializer5dcedea58465d384400989 && ($this->initializer5dcedea58465d384400989->__invoke($valueHolder5dcedea584659052366045, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5dcedea58465d384400989) || 1) && $this->valueHolder5dcedea584659052366045 = $valueHolder5dcedea584659052366045;

        return $this->valueHolder5dcedea584659052366045->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5dcedea58465d384400989 && ($this->initializer5dcedea58465d384400989->__invoke($valueHolder5dcedea584659052366045, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5dcedea58465d384400989) || 1) && $this->valueHolder5dcedea584659052366045 = $valueHolder5dcedea584659052366045;

        return $this->valueHolder5dcedea584659052366045->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5dcedea58465d384400989 = $initializer;
    }
    ...
    {
        $this->initializer5dcedea58465d384400989 && ($this->initializer5dcedea58465d384400989->__invoke($valueHolder5dcedea584659052366045, $this, '__get', array('name' => $name), $this->initializer5dcedea58465d384400989) || 1) && $this->valueHolder5dcedea584659052366045 = $valueHolder5dcedea584659052366045;

        if (isset(self::$publicProperties5dcedea58464c099629374[$name])) {
            return $this->valueHolder5dcedea584659052366045->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5dcedea584659052366045;
    ...
    {
        $this->initializer5dcedea58465d384400989 && ($this->initializer5dcedea58465d384400989->__invoke($valueHolder5dcedea584659052366045, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5dcedea58465d384400989) || 1) && $this->valueHolder5dcedea584659052366045 = $valueHolder5dcedea584659052366045;
    ...
    {
        $this->initializer5dcedea58465d384400989 && ($this->initializer5dcedea58465d384400989->__invoke($valueHolder5dcedea584659052366045, $this, '__isset', array('name' => $name), $this->initializer5dcedea58465d384400989) || 1) && $this->valueHolder5dcedea584659052366045 = $valueHolder5dcedea584659052366045;
    ...
    {
        $this->initializer5dcedea58465d384400989 && ($this->initializer5dcedea58465d384400989->__invoke($valueHolder5dcedea584659052366045, $this, '__unset', array('name' => $name), $this->initializer5dcedea58465d384400989) || 1) && $this->valueHolder5dcedea584659052366045 = $valueHolder5dcedea584659052366045;
    ...
    {
        $this->initializer5dcedea58465d384400989 && ($this->initializer5dcedea58465d384400989->__invoke($valueHolder5dcedea584659052366045, $this, '__clone', array(), $this->initializer5dcedea58465d384400989) || 1) && $this->valueHolder5dcedea584659052366045 = $valueHolder5dcedea584659052366045;

        $this->valueHolder5dcedea584659052366045 = clone $this->valueHolder5dcedea584659052366045;
    }

    public function __sleep()
    {
        $this->initializer5dcedea58465d384400989 && ($this->initializer5dcedea58465d384400989->__invoke($valueHolder5dcedea584659052366045, $this, '__sleep', array(), $this->initializer5dcedea58465d384400989) || 1) && $this->valueHolder5dcedea584659052366045 = $valueHolder5dcedea584659052366045;

        return array('valueHolder5dcedea584659052366045');
    }
    ...
    {
        return $this->initializer5dcedea58465d384400989;
    }
    ...
    {
        return $this->initializer5dcedea58465d384400989 && ($this->initializer5dcedea58465d384400989->__invoke($valueHolder5dcedea584659052366045, $this, 'initializeProxy', array(), $this->initializer5dcedea58465d384400989) || 1) && $this->valueHolder5dcedea584659052366045 = $valueHolder5dcedea584659052366045;
    }
    ...
    {
        return null !== $this->valueHolder5dcedea584659052366045;
    }
    ...
    {
        return $this->valueHolder5dcedea584659052366045;
    }
