...
class News
{
    ...
    public function getNewsList() {
        $result = [];
        $dbRes = $this->DB->query("SELECT n.NEWS_ID, n.NEWS_NAME, n.USERS_ID, n.NEWS_VIEW_TEXT, n.NEWS_VIEW_PICTURE, n.NEWS_CREATED_AT, u.USERS_LOGIN, u.USERS_FIRST_NAME, u.USERS_LAST_NAME FROM news n LEFT JOIN users u on n.users_id = u.users_id order by n.NEWS_CREATED_AT desc");
